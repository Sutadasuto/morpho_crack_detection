...
def main(args):
    description = "Min-Max contrast enhancement\n" \
                  ...
                  "2*MAD from median threshold using b=1.4826 (calculated on h(-i) union h(i) where h is the frequency of pixels with intensity i)\n" \
    ...
    for idx, image in enumerate(images):
        ...
        cracks, preprocessing = morpho_utils.find_cracks_adaptive_threshold(image, se_size=10, ori_step=10, window_size=(50, 50))
